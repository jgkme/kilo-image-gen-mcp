...
description: Use img-gen-mcp background_remove prompts with local segmentation models and transparent PNG output.
---
...
- Use `backend=withoutbg` when you want the shared daemon for harder edges.
...
- For website logos and favicons, follow up with `website-asset-workflow` so the cutout gets cropped, resized, and optimized correctly.
